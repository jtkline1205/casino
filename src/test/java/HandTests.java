...
public class HandTests {
	...
	public void hardTest() {
		...
		hardHands.add(createHand(10, 4));
		hardHands.add(createHand(8, 9));
		hardHands.add(createHand(2, 10));
		hardHands.add(createHand(10, 10));
		hardHands.add(createHand(4, 10));
		hardHands.add(createHand(10, 5));
